package com.example.checklstapp;
...
import com.example.checklstapp.viewmodel.ShowItemListActivityViewModel;
...
public class ShowItemsListActivity extends AppCompatActivity implements ItemsListAdapter.HandleItemsClick {
    ...
    private void saveNameitem(String itemName){
